...
export default class CreateJob extends React.Component {
    ...
    loadData() {
        ...
        if (param != "" || copyJobParam != "" ) {
            var link = param != "" ? 'http://talentmvp.azurewebsites.net/listing/listing/GetJobByToEdit?id=' + param
                : 'http://talentmvp.azurewebsites.net/listing/listing/GetJobForCopy?id=' + copyJobParam;
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.success == true) {
                        ...
                        //res.jobData.description=moment(res.jobData.description);
    ...
    addUpdateJob() {
        ...
        var cookies = Cookies.get('talentAuthToken');   
        $.ajax({
            url: 'http://talentmvp.azurewebsites.net/listing/listing/createUpdateJob/',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
